<template>
   <div class="container center-items height-100">
      <div class="row">
        <!-- start form inputs -->
          <form @submit.prevent="submitFormMethod" class="container-form-v center-items">
            <div class="subtitle">
              <h1>Join now</h1>
            </div>
            <div class="form-input-group-v">
              <div class="input-v" v-if="showUsername">
                <input 
                  :class="{ 'input-error-v' : (!$v.username.required||!$v.username.email) }"
                  class="input-value-v" 
                  type="text" 
              ...
              <div class="switch-page">
                ...
                <div class="switch-page-link mt-3">
                  <router-link :to="{ name: linkTo }" class="title">
                    {{linkTitle}}
                  </router-link>
                </div>
              </div>
